                        ...
                        <div className="space-y-8">
                          <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <ul className="space-y-3 text-gray-700 list-none pl-0">
                              <li className="flex items-start">
                                ...
                                <span>Conviction: Possession with Intent to Sell a Controlled Substance (Class B felony)</span>
                              </li>
                              <li className="flex items-start">
                                <span className="mr-2">•</span>
                              ...
                              <li className="flex items-start">
                                <span className="mr-2">•</span>
                                <span>Sentence: Indeterminate 1–9 years; served four years in state custody (June 2019 – June 2023)</span>
                              </li>
                              <li className="flex items-start">
                                <span className="mr-2">•</span>
                                <span>Release & Supervision: Paroled in June 2023; completed all parole and probation requirements by May 2025</span>
                              </li>
                              <li className="flex items-start">
                                <span className="mr-2">•</span>
                                <span>Parole Violation: One curfew violation recorded in September 2023; resulted in a formal warning and no further sanctions</span>
                              </li>
                            </ul>
                          </div>
                          ...
                          <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div>
                              ...
                              <ul className="space-y-2 text-gray-700 list-none pl-0">
                                <li className="flex items-start">
                                  <span className="mr-2">•</span>
                                  <span>Prospect and qualify leads through outreach and inbound inquiries</span>
                                </li>
                                <li className="flex items-start">
                                  <span className="mr-2">•</span>
                                  <span>Conduct product demonstrations and articulate value propositions</span>
                                </li>
                                <li className="flex items-start">
                                  <span className="mr-2">•</span>
                                  <span>Maintain and update CRM records with accurate opportunity and pipeline data</span>
                                </li>
                                <li className="flex items-start">
                                  <span className="mr-2">•</span>
                                  <span>Collaborate with marketing and customer success teams to ensure seamless customer experiences</span>
                                </li>
                                <li className="flex items-start">
                                  <span className="mr-2">•</span>
                                  <span>Meet or exceed individual sales targets and contribute to team goals</span>
                                </li>
                              </ul>
                            </div>
                          </div>
                          ...
                          <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <ul className="space-y-3 text-gray-700 list-none pl-0">
                              <li className="flex items-start">
                                <span className="mr-2">•</span>
                                <span>You will be guided through an individualized assessment process</span>
                              </li>
                              <li className="flex items-start">
                                <span className="mr-2">•</span>
                                <span>Each factor will be evaluated on a scale of 1-7</span>
                              </li>
                              <li className="flex items-start">
                                <span className="mr-2">•</span>
                                <span>You will have the opportunity to provide notes for each factor</span>
                              </li>
                              <li className="flex items-start">
                                <span className="mr-2">•</span>
                                <span>At the end, you will make a final decision: Hire, Do Not Hire, or Send for Further Review</span>
                              </li>
                            </ul>
                          </div>
                        </div>
